...
import styles from "../../event/form/EventFormScreen.styles";
import { Picker } from '@react-native-picker/picker';
import { usePendingEventForm } from "../../../hooks/pendingEvent/usePendingEventForm";
...
{errors.day && <Text style={{ color: colors.error, marginBottom: 5 }}>{errors.day}</Text>}
  ...
  <Text style={{ color: colors.success, marginBottom: 5 }}>✓ Data válida</Text>
      ...
      <TextInput 
      style={[styles.input, { 
        backgroundColor:  errors.targetAudience
            ? colors.inputErrorBackground
