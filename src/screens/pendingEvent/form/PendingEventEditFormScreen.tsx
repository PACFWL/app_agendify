...
import styles from "./PendingEventFormScreen.styles";
import DateTimePicker from "@react-native-community/datetimepicker";
import { format } from "date-fns";
import { ptBR } from "date-fns/locale";
import { TouchableOpacity } from "react-native";
import { Picker } from "@react-native-picker/picker";
import { usePendingEventEditForm } from "../../../hooks/pendingEvent/usePendingEventEditForm";
      ...
      const fetchPendingEvent = async () => {
        ...
        try {
          ...
          setErrors((prev) => {
            ...
            if (eventDate < today) {
              newErrors.day = "A data do evento pendente está no passado. Para atualizar o evento pendente, é necessário alterar a data.";
            } else {
